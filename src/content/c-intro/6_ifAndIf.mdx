...
*************************
At the moment, it's not raining, so I don't need an umbrella. Let's say it starts raining. Complete the code so that It rains outside, so I gotta take my pink umbrella can be printed on the screen. 
